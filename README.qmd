...
In this section, we will run and interpret three multiple regressions to try and understand what influences crab body width in mm (`size`). Let's remind ourselves of the columns in the crab data: 
